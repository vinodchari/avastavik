...
var main = (function($) { var _ = {
	...
	initGraphics:function(){
		var webglEl = document.getElementById('viewer');
		...
		document.getElementById("viewer").addEventListener('mousewheel', main.onMouseWheel, false);
		document.getElementById("viewer").addEventListener('DOMMouseScroll', main.onMouseWheel, false);
									...
									//window.setTimeout(function() {
										...
										// Mark as active.
											...
											new THREE.SphereGeometry(100, 20, 20),
												...
												map: new THREE.TextureLoader().load(newSlide.url)})
												);
											sphere.scale.x = -1;
											scene.add(sphere);
	...
	graphics: function(){
		...
		document.getElementById("viewer").addEventListener('mousewheel', main.onMouseWheel, false);
		document.getElementById("viewer").addEventListener('DOMMouseScroll', main.onMouseWheel, false);
	/*	document.addEventListener('mousewheel', main.onMouseWheel, false);
		document.addEventListener('DOMMouseScroll', main.onMouseWheel, false);
*/
		main.render();
